...
pub fn gen_idl_types(input: proc_macro::TokenStream) -> proc_macro::TokenStream {
    ...
    // TODO: namespace the types, modules, events for better discover-ability/dx
...
fn field_to_token_stream(f: &IdlField) -> TokenStream {
    ...
    // nb: arrays with len > 32 do not implement important traits e.g PartialEq, Serialize, etc.
